    ...
    <section class="latest">
      <div class="container">
        ...
        <div class="latest__wrapper">
          ...
          <div class="card__md">
            <img src=" <?php echo get_template_directory_uri()?>./img/img-8.jpg
            " alt="" />
            <div class="card__md__content">
              <ul>
                <li><small>May 21, 2010</small></li>
    ...
    <section class="feature">
      ...
      <div class="container">
        <div class="feature__img">
          <img src=" <?php echo get_template_directory_uri()?>./img/img-9.jpg
          " alt="" />
        </div>
      </div>
        ...
        <div class="feature__wrapper">
          <div class="feature__main">
            <article class="card__lg">
              <img src=" <?php echo get_template_directory_uri()?>./img/img-10.jpg
              " alt="" />
            ...
            <article class="card__lg">
              <img src=" <?php echo get_template_directory_uri()?>./img/img-11.jpg
              " alt="" />
              <div class="card__lg__content">
                <small>Oct 2, 2022</small>
                <h3>
            ...
            <article class="card__lg">
              <img src=" <?php echo get_template_directory_uri()?>./img/img-12.jpg
              " alt="" />
              <div class="card__lg__content">
                <small>Oct 2, 2022</small>
                <h3>
